...
public class GarageManager : MonoBehaviour
{
    ...
    private string[] Details = { "기름칠하고 달릴 준비를 하세요. 몸매가 제대로 빠진 이 화끈한 녀석의 출격을 기다리고 있습니다. 클래식한 럭셔리를 뽐내는 JB 700W를 타고 밖으로 나가십시오.",
                                 ...
                                 "알파는 현대적 성능과 디자인을 고급 자동차의 클래식한 멋과 융합한 자동차이며 말끔합니다. 자신이 운전하고 있다는 걸 깜빡할 정도로요. 물론 시속 200km로 달릴 때는 그게 문제가 될 수 있지만요.",
                                 "스마트 안전장치나 하이테크 주행 지원은 없습니다. 하지만 이 차에서 당신이 해야할 일은 간단합니다. 이 차 덕분에 당신이 얼마나 멋있게 보이는지 생각하세요.",
                                 "독일식 엔지니어링과 설계방식을 매우 신중하게 적용했습니다. 이 퓨지티브 모델은 마음에 들지 않는 상사의 남은 머리카락 한 가닥까지 날려버릴 수 있습니다." };
