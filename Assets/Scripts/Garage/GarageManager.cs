...
public class GarageManager : MonoBehaviour
{
    ...
    private string[] Details = { "기름칠하고 달릴 준비를 하세요. 몸매가 제대로 빠진 이 화끈한 녀석의 출격을 기다리고 있습니다. 클래식한 럭셔리를 뽐내는 JB 700W를 타고 밖으로 나가십시오. 모두가 당신을 개자식이라고 떠들어대는 건 뒤로 하고요.",
                                 "80년대에 나온 것들은 죄다 낡았습니다. 라피드 GT 클래식만이 성숙하게 발전했죠. 물론 새로운 스포츠 쿠페는 무게도 가볍고, 변속도 깔끔하겠지만 저희를 믿으세요. 오직 시간만이 말해줄 수 있는 자신감이 무엇인지 알게 될 겁니다.",
                                 "알파는 현대적 성능과 디자인을 고급 자동차의 클래식한 멋과 융합한 자동차이며 말끔합니다. 자신이 운전하고 있다는 걸 깜빡할 정도로요. 물론 시속 240km로 달릴 때는 그게 문제가 될 수 있지만요.",
                                 "멋보다 성능을 중시하는 차를 원하신다면 잘못 찾아오셨습니다. 물론 GT500을 타고도 A 지점에서 B 지점까지 갈 수 있죠. 하지만 당신이 해야할 일은 간단합니다. 담배에 불을 붙이고, 멋진 포즈를 잡고, 이 차 덕분에 당신이 얼마나 멋있게 보이는지 생각하세요.",
