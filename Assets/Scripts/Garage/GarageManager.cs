...
public class GarageManager : MonoBehaviour
{
    ...
    private string[] Details = { "차에 탑승해서, 달릴 준비를 하세요. 몸매가 제대로 빠진 이 녀석의 출격을 기다리고 있습니다. 클래식한 럭셔리를 뽐내는 JB 700W를 타고 밖으로 나가세요.",
                                 "구시대에 나온 것들은 죄다 낡았습니다만 라피드 GT 클래식은 성숙하게 발전했습니다. 물론 새로운 스포츠 카는 무게도 가볍고, 변속도 깔끔하겠지만 오직 시간만이 말해줄 수 있는 자신감이 무엇인지 알게 될 겁니다.",
                                 "알파는 현대적 성능과 디자인을 고급 자동차의 클래식한 멋과 융합한 자동차이며 말끔하며, 빠릅니다. 자신이 운전하고 있다는 걸 깜빡할 정도로요.",
